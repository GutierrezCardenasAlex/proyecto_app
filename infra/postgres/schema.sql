...
CREATE TABLE IF NOT EXISTS users (
  ...
  promo_progress_count INTEGER NOT NULL DEFAULT 0,
  free_trip_credits INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS drivers (
  ...
  access_status VARCHAR(20) NOT NULL DEFAULT 'AUTORIZADO',
  access_note TEXT,
...
CREATE TABLE IF NOT EXISTS vehicles (
  ...
  vehicle_type VARCHAR(16) NOT NULL DEFAULT 'taxi',
...
CREATE TABLE IF NOT EXISTS trips (
  ...
  promotional_trip BOOLEAN NOT NULL DEFAULT FALSE,
