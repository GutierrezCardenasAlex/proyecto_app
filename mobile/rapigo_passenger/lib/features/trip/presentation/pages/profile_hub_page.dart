...
class ProfileHubPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final normalizedProgress = session.promoProgressCount.clamp(0, safeCycleLength).toInt();
                      ...
                      child: Column(
                        children: [
                          _ProfileMenuTile(
                            ...
                            title: 'Editar perfil',
                            subtitle: 'Nombre, telefono, correo y datos visuales.',
                          ...
                          _ProfileMenuTile(
                            ...
                            title: 'Promociones',
                            subtitle: 'Beneficios, descuentos y regalos disponibles.',
                            onTap: () => _openPage(context, const PromotionsPage()),
                          ),
                          const SizedBox(height: 8),
                          _ProfileMenuTile(
